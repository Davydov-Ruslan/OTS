classdef ClassMapper < handle
	% Класс выполняет процесс модуляции /демодуляции
    properties (SetAccess = private) % Переменные из параметров
		...
		% ВАЖНО: 
		% Если в кодировании выбирать режим декодирования с жесткими решенями 
		% то здесь DecisionMethod = 'Hard decision'; если с мягкими решениями
		% то DecisionMethod = 'Log-likelihood ratio' или 
